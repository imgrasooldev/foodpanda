...
export function AuthGate({ children }: { children: ReactNode }) {
  const { user, ready } = useVendorAuth();
      ...
      <div className="w-full max-w-sm">
        <div className="mb-6 flex items-center justify-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-slate-400">Partner Portal</p>
          </div>
        </div>

        <form onSubmit={submit} className="rounded-2xl bg-white p-6 shadow-card">
          <h1 className="mb-1 text-xl font-extrabold">Partner sign in</h1>
          ...
          <div className="relative mb-3">
            ...
            <input
              ...
              placeholder="owner@studentbiryani.pk"
          ...
          <div className="mt-4 rounded-lg bg-slate-50 p-3 text-xs text-slate-500">
            ...
            <p>Email: owner@studentbiryani.pk</p>
